...
public class ShareModel {
    ...
    public ShareModel(Long userId, Long companyId, int sharesNumbers, CompanyModel companyModel) {
        this.userId = userId;
    ...
    public int getSharesNumbers() {
        return sharesNumbers;
    }

    public void setSharesNumbers(int sharesNumbers) {
        this.sharesNumbers = sharesNumbers;
    }
